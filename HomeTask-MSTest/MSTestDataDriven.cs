...
namespace HomeTask_MSTest
{
    ...
    public class MSTestDataDriven
    {
        ...
        [DataRow(1,1)]
        [DataRow(2, 2)]
        public void Abs(double x, double z)
        {
            // Arrange
            Calculator myCalculator = new Calculator();
            // Act
        ...
        public void Cos(double x, double z)
        {
            // Arrange
            Calculator myCalculator = new Calculator();
            // Act
        ...
        [DataRow(1, false)]
        [DataRow(-2, true)]
        public void isNegative(double x,  bool z)
        {
            // Arrange
            Calculator myCalculator = new Calculator();
            // Act
        ...
        [DataRow(-1, false)]
        [DataRow(2, true)]
        public void isPositive(double x, bool z)
        {
            // Arrange
            Calculator myCalculator = new Calculator();
            // Act
        ...
        [DataRow(1, 1, 1)]
        public void Pow(double x, double y, double z)
        {
            // Arrange
            Calculator myCalculator = new Calculator();
            // Act
        ...
        public void Sin(double x, double z)
        {
            // Arrange
            Calculator myCalculator = new Calculator();
            // Act
        ...
        [DataRow(144, 12)]
        [DataRow(625,25)]
        public void Sqrt(double x, double z)
        {
            // Arrange
            Calculator myCalculator = new Calculator();
            // Act
